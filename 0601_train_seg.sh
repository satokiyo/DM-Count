...
#activation=identity # Available options are **"sigmoid"**, **"softmax"**, **"logsoftmax"**, **"tanh"**, **"identity"**, **callable** and **None**.
#neptune_tag=('efficientnetv2_l' 'unet' 'deep_supervision' 'copy_paste')
##neptune_tag=(${neptune_tag[@]} 'vgg19_bn' 'unet' 'deep_supervision' 'copy_paste' 'ocr')
#encoder_name=efficientnetv2_l # vgg19_bn hrnet_seg hrnet_seg_ocr  dpn98 resnet152 vgg19_bn timm-resnest50d efficientnet-b5 timm-resnest50d_4s2x40d vgg19_bn mobilenet_v2 timm-efficientnet-lite4 timm-skresnext50_32x4d se_resnext50_32x4d timm-efficientnet-b6 se_resnext101_32x4d xception 
#batch_size=4
#deep_supervision=1
#use_albumentation=1
#use_copy_paste=1
