...
parser.add_argument('--test-type', type=str, default='val',) # 'val_no_gt':count only, 'val' : show gt overlay, 'test_no_gt': without gt
...
#            cv2.imwrite(os.path.join(args.pred_density_map_path, str(name) + '.jpg'), img_w_heatmap.transpose(1,2,0))
#
#            # detect/draw center point
...
elif args.test_type in ['val_no_gt', 'test_no_gt']: # without gt
    #image_errs = []
    #for inputs, count, name in dataloader:
    #for inputs, name in dataloader:
