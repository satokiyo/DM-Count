...
#        self.encoder1 = nn.Conv2d(3, 16, 3, stride=1, padding=1)  # change
...
#        self.encoderf1 =   nn.Conv2d(3, 16, 3, stride=1, padding=1)  # change
...
#        self.final = nn.Conv2d(8,1,1,stride=1,padding=0) # change to output 1ch
#        
#        self.soft = nn.Softmax(dim =1)

# temp
        #self.encoder1 = nn.Conv2d(1, 16, 3, stride=1, padding=1)  # First Layer GrayScale Image , change to input channels to 3 in case of RGB 
        self.encoder1 = nn.Conv2d(3, 8, 3, stride=1, padding=1)  # change
        self.en1_bn = nn.BatchNorm2d(8)
        self.encoder2=   nn.Conv2d(8, 16, 3, stride=1, padding=1)  
        self.en2_bn = nn.BatchNorm2d(16)
        self.encoder3=   nn.Conv2d(16, 32, 3, stride=1, padding=1)
        self.en3_bn = nn.BatchNorm2d(32)

        self.decoder1 =   nn.Conv2d(32, 16, 3, stride=1, padding=1)   
        self.de1_bn = nn.BatchNorm2d(16)
        self.decoder2 =   nn.Conv2d(16,8, 3, stride=1, padding=1)
        self.de2_bn = nn.BatchNorm2d(8)
        self.decoder3 =   nn.Conv2d(8, 4, 3, stride=1, padding=1)
        self.de3_bn = nn.BatchNorm2d(4)

        self.decoderf1 =   nn.Conv2d(32, 16, 3, stride=1, padding=1)
        self.def1_bn = nn.BatchNorm2d(16)
        self.decoderf2=   nn.Conv2d(16, 8, 3, stride=1, padding=1)
        self.def2_bn = nn.BatchNorm2d(8)
        self.decoderf3 =   nn.Conv2d(8, 4, 3, stride=1, padding=1)
        self.def3_bn = nn.BatchNorm2d(4)

        #self.encoderf1 =   nn.Conv2d(1, 8, 3, stride=1, padding=1)  # First Layer GrayScale Image , change to input channels to 3 in case of RGB 
        self.encoderf1 =   nn.Conv2d(3, 8, 3, stride=1, padding=1)  # change
        self.enf1_bn = nn.BatchNorm2d(8)
        self.encoderf2=   nn.Conv2d(8, 16, 3, stride=1, padding=1)
        self.enf2_bn = nn.BatchNorm2d(16)
        self.encoderf3 =   nn.Conv2d(16, 32, 3, stride=1, padding=1)
        self.enf3_bn = nn.BatchNorm2d(32)

        self.intere1_1 = nn.Conv2d(8,8,3, stride=1, padding=1)
        self.inte1_1bn = nn.BatchNorm2d(8)
        self.intere2_1 = nn.Conv2d(16,16,3, stride=1, padding=1)
        self.inte2_1bn = nn.BatchNorm2d(16)
        self.intere3_1 = nn.Conv2d(32,32,3, stride=1, padding=1)
        self.inte3_1bn = nn.BatchNorm2d(32)

        self.intere1_2 = nn.Conv2d(8,8,3, stride=1, padding=1)
        self.inte1_2bn = nn.BatchNorm2d(8)
        self.intere2_2 = nn.Conv2d(16,16,3, stride=1, padding=1)
        self.inte2_2bn = nn.BatchNorm2d(16)
        self.intere3_2 = nn.Conv2d(32,32,3, stride=1, padding=1)
        self.inte3_2bn = nn.BatchNorm2d(32)

        self.interd1_1 = nn.Conv2d(16,16,3, stride=1, padding=1)
        self.intd1_1bn = nn.BatchNorm2d(16)
        self.interd2_1 = nn.Conv2d(8,8,3, stride=1, padding=1)
        self.intd2_1bn = nn.BatchNorm2d(8)
        self.interd3_1 = nn.Conv2d(32,32,3, stride=1, padding=1)
        self.intd3_1bn = nn.BatchNorm2d(32)

        self.interd1_2 = nn.Conv2d(16,16,3, stride=1, padding=1)
        self.intd1_2bn = nn.BatchNorm2d(16)
        self.interd2_2 = nn.Conv2d(8,8,3, stride=1, padding=1)
        self.intd2_2bn = nn.BatchNorm2d(8)
        self.interd3_2 = nn.Conv2d(32,32,3, stride=1, padding=1)
        self.intd3_2bn = nn.BatchNorm2d(32)

        #self.final = nn.Conv2d(4,2,1,stride=1,padding=0)
        self.final = nn.Conv2d(4,1,1,stride=1,padding=0) # change to output 1ch
